...
faces, labels = load_images('faces')
...
mean, space, projected_data= PCA(train_data,0.85) #perform pca on train
train_projected = (train_data - mean) @ space # transform train data
test_projected = (test_data - mean) @ space # transform test data
...
print("Accuracy of KNN classifier with k=1 after PCA with alpha=0.85 & split=70%", acc70)
print("Accuracy of KNN classifier with k=1 after PCA with alpha=0.85 &:split=50%", acc50)
